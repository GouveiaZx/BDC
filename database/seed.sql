...
-- Plano Gratuito
('Gratuito', 'gratuito', 'Ideal para quem está começando. Publique seu primeiro anúncio gratuitamente.', 0.00, 0.00, 1, 0, 30, 5, false, 0, false),

-- Plano Microempresa
('Microempresa', 'microempresa', 'Para pequenos negócios que precisam de mais visibilidade.', 24.90, 249.00, 2, 0, 30, 8, false, 1, false),

-- Plano Pequena Empresa
('Pequena Empresa', 'pequena-empresa', 'Para empresas em crescimento com necessidade de destaque.', 49.90, 499.00, 5, 1, 30, 10, true, 2, false),

-- Plano Empresa
('Empresa', 'empresa', 'Para empresas estabelecidas que querem máxima visibilidade.', 99.90, 999.00, 10, 2, 30, 10, true, 3, true),

-- Plano Empresa Plus
('Empresa Plus', 'empresa-plus', 'Para grandes empresas com necessidades premium.', 149.90, 1499.00, 20, 3, 30, 10, true, 5, true);
