...
const PLANS: { [key: string]: Plan } = {
  'gratuito': {
    ...
    features: ['1 anúncio a cada 60 dias', '30 dias de duração', 'Suporte por email']
  },
  'micro-empresa': {
    id: 'micro-empresa',
    name: 'Micro-Empresa',
    ...
    features: ['2 anúncios simultâneos', '30 dias de duração', '1 destaque por dia', 'Suporte por email']
  },
  'pequena-empresa': {
    id: 'pequena-empresa',
    ...
    features: ['5 anúncios simultâneos', '30 dias de duração', '2 destaques por dia', 'Estatísticas detalhadas', 'Suporte por chat']
  },
  'empresa-simples': {
    id: 'empresa-simples', 
    ...
    features: ['10 anúncios simultâneos', '30 dias de duração', '4 destaques por dia', 'Estatísticas avançadas', 'Suporte prioritário']
  },
  'empresa-plus': {
    id: 'empresa-plus',
    name: 'Empresa Plus', 
    ...
    features: ['20 anúncios simultâneos', '30 dias de duração', '8 destaques por dia', 'Estatísticas premium', 'Suporte dedicado']
  }
}
