                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:suporte@bdcclassificados.com.br" className="text-blue-600 hover:text-blue-800">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/5500000000000" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                        (00) 0000-0000
                      </a>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+550000000000" className="text-blue-600 hover:text-blue-800">
                        (00) 0000-0000
                      </a>
                      <p className="text-sm text-gray-500 mt-1">
                        Seg-Sex, 8h às 18h
