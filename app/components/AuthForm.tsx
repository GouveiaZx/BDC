          ...
          <>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className={`ml-2 block text-sm ${errors.terms ? 'text-red-500' : 'text-gray-400'}`}>
                                  Concordo com os <a href="/termos-uso" className="text-primary hover:text-primary-light">Termos de Uso</a> e <a href="/politica-privacidade" className="text-primary hover:text-primary-light">Política de Privacidade</a>
              </label>
            </div>
