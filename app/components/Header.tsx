...
// Hook seguro para pathname que evita problemas de hidratação
const useClientPathname = () => {
  ...
  // Listener para mudanças de rota usando apenas APIs do browser
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Observer para mudanças no DOM (para navegação SPA)
              ...
              <div className="relative">
                ...
                >
                  <Avatar
                    ...
                    alt="Perfil"
                    size={32}
                    fallbackName={profile?.name || userName}
                  />
                  <span className="text-white max-w-[100px] truncate">{profileLoading ? 'Carregando...' : (profile?.name || userName)}</span>
                </button>
                ...
                {userMenuOpen && (
                  ...
                  >
                    <div className="flex items-center px-4 py-3 border-b border-gray-200">
                      ...
                      />
                      <div>
                        <p className="font-medium text-gray-800 truncate">{profileLoading ? 'Carregando...' : (profile?.name || userName)}</p>
                ...
                {isLoggedIn ? (
                  <>
                    <div className="py-2 flex items-center gap-3">
                      ...
                      />
                      <div>
                        <p className="font-medium text-gray-800">{profileLoading ? 'Carregando...' : (profile?.name || userName)}</p>
