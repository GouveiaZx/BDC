            ...
            >
              ...
              <div className={`p-3 md:p-4 flex items-center space-x-3 ${usuario.isAdmin ? 'bg-green-50 border-b border-green-100' : 'border-b border-gray-100'}`}>
                <Link 
                  ...
                  className="relative h-8 w-8 md:h-10 md:w-10 rounded-full overflow-hidden border-2 border-gray-200 hover:border-blue-400 transition-colors cursor-pointer flex-shrink-0"
